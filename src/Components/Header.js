...
class Header extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      showPassword: false,
      anchor: null,
      dialogElement: this.getDefaultLogin(props.classes),
      email: '',
      name: '',
      password: '',
      isLogin: '',
  ...
  getLoginDialog = (classes, type = 'default') => {
    ...
    if(type === 'signin') {
      ...
      return this.getDefaultLogin(classes);
    }
  }

  getDefaultLogin = (classes) => {
    return (<div>
      <DialogTitle align="center" disableTypography className={classes.root}>
        <Typography display="block" align="center" variant="h5">
          Join WikiPages.in
          ...
          <AppBar className={classes.appBar}>
            <Container>
              <Toolbar>
                ...
                {isMobile?null:<Button onClick={this.state.isLogin?null:this.handleClickOpenLoginDialog} component={this.state.isLogin?RouterLink:Button} to={ClientUrls.publish} size="small" className={classes.button} variant="outlined" color="default">Publish</Button>}
